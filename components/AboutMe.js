  ...
  return (
    <section className="bg-gray-100 dark:bg-gray-900 mb-24">
      ...
      <div className="bg-[#F1F1F1] dark:bg-gray-900 px-4">
        <div className="pt-6 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20">
          {/* Social Buttons */}
          <div className="inline-flex flex-col">
            ...
            <div >
              ...
              <p className="text-lg text-gray-500 mt-4 dark:text-gray-300">
                Opportunities always are welcome, please contact me if you're interested.
              </p>
            </div>
            {/* Social Links */}
            <h1 className="text-xl font-semibold text-gray-700 mt-10 dark:text-gray-200">
              Social Links
            </h1>
